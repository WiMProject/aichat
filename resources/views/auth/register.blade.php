...
@section('title', 'Register - AI Chat')
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
    ...
    <div class="relative z-10 max-w-md w-full mx-4">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-300">Buat akun untuk memulai</p>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-300">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" class="font-medium text-blue-400 hover:text-blue-300 transition duration-200">
                        Masuk di sini
                    </a>
                </p>
            </div>
